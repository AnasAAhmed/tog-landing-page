...
const Hero = () => {
    return (
        <section className="relative overflow-hidden bg-s[url('/images/hero.png')] bg-[#FD5A17] pt-30 pb-24 md:pb-36 psx-4">
            ...
            <div style={{ animationDuration: `${3 + 2 * 0.3}s` }} className="absolute animate-float top-0 left-1/2 -translate-x-1/2 w-24 md:w-32 h-24 md:h-32 opacity-90">
                <img
                    // src="/icons/insta.png"
            ...
            <div style={{ animationDuration: `${3 + 5 * 0.3}s` }} className="absolute animate-float top-12 md:top-8 right-0 md:right-24 w-20 md:w-32 h-20 md:h-32 opacity-90">
                <Image
                    src="/icons/x.png"
                    alt="x"
                    fill
            ...
            <div style={{ animationDuration: `${3 + 3 * 0.3}s` }} className="absolute animate-float -bottom-6 left-1/2 w-32 md:w-60 h-32 md:h-60 -translate-x-1/2 opacity-90">
                <Image
            ...
            <div style={{ animationDuration: `${3 + 7 * 0.3}s` }} className="hidden lg:block animate-float absolute w-48 lg:w-110 h-48 lg:h-110 top-12 md:top-24 -right-24 opacity-90">
            ...
            <div style={{ animationDuration: `${3 + 1 * 0.3}s` }} className="hidden lg:block animate-float absolute w-32 md:w-60 h-48 md:h-60  top-36 md:top-48 left-4 md:right-24 opacity-90">
                <Image
            ...
            <div style={{ animationDuration: `${3 + 8 * 0.3}s` }} className="absolute animate-float bottom-0 md:bottom-16 left-0 md:left-32 w-16 md:w-28 h-16 md:h-28 opacity-90">
                <Image
            ...
            <div style={{ animationDuration: `${3 + 9 * 0.3}s` }} className="absolute animate-float bottom-0 md:bottom-8 right-0 md:right-24 w-28 md:w-52 h-28 md:h-52 opacity-90">
                <Image
            ...
            <div className="relative z-10 flex flex-col items-center text-center mxs-auto">
                ...
                <div className="flex flex-row items-center justify-center gap-3 md:gap-5 max-w-2xl max-sm:px-2 mx-auto">
                    ...
                    {/* <button
                        className=" btn-japanese  min-w-[120px] sm:min-w-[150px] md:min-w-[180px] 
               ...
               text-white hover:bg-gray-900 transition-colors"
                    ...
                    <button className="hidden md:block btn-animated min-w-[120px] sm:min-w-[150px] md:min-w-[180px] rounded py-[13px]
                            font-body text-base text-[10px] sm:text-lg md:text-xl">
