...
export default function HowItWorks() {
  ...
  return (
    <div className="min-h-screen bg-[url('/images/how-it-works.png')] bg-no-repeat bg-containbg-no-repeat
    bg-lesft
    bg-[#FFC803]
    overflow-x-hidden
              ...
              <div className="space-y-6 sm:space-y-11">
                ...
                {steps.map((i, _) => (
                  ...
                  <div key={_} className="flex gap-4">
                    ...
                    <p className="font-questrial text-[17px] leading-7 tracking-[-0.4px] text-black">
                      {i}
                    </p>
                  </div>))}
              </div>
            ...
            >
              ...
              <div className="relative md:px-10 lg:px-14">
                ...
                <button
                  ...
                  className="absolute cursor-pointer -bottom-22 sm:bottom-1/2 right-1/3 lg:-right-10 w-20 h-20 md:w-[100px] md:h-[100px] rounded-full bg-[#FD5A17] border-2 border-black flex items-center justify-center hover:scale-105 transition-transform"
