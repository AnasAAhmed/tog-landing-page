  ...
  return (
    <div id="how-it-works" className="min-h-screen bg-[url('/images/how-it-works.png')] bg-no-repeat bg-contain bg-left bg-[#FFC803] overflow-x-hidden">
      <div className="relative w-full h-full px-4 sm:px-8 lg:px-20 py-8 md:py-16 lg:py-20">
        ...
        {/* Fixed flex container with proper height management */}
        <div className="flex flex-col lg:flex-row justify-center items-stretch gap-6 md:gap-8 my-8 md:my-12 lg:my-16">

          {/* First div - constrained width on large screens */}
          <div className="w-full lg:w-[400px] xl:w-[450px] flex-shrink-0">
            <div
              className="bg-[#FD5A17] rounded-xl border-2 border-black/50 py-8 md:py-10 lg:py-13 px-8 md:px-7 xl:px-10 h-full flex flex-col"
              ...
              <div className="space-y-6 flex-grow">
                {steps.map((i, _) => (
                  <div key={_} className="flex gap-4">
                    ...
                    <p style={{ fontFamily: 'var(--font-questrial)' }} className="text-[16px] xl:text-[20px] text-black">
                      {i}
                    </p>
                  </div>
                ))}
          ...
          {/* Second div - takes remaining space and matches height */}
          <div id="blogs" className="flex-1 min-w-0">
            <div
              className="bg-[#FD5A17] rounded-xl border-2 border-black/50 pb-3 md:pb-6 lg:pb-8 pt-8 md:pt-12 lg:pt-14 h-full flex flex-col"
              style={{ boxShadow: '8px 8px 0 0 #000' }}
            >
              ...
              <div className="relative md:px-10 lg:px-14 flex-grow">
                <div ref={scrollRef}
